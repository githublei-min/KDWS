...
class Loss(nn.modules.loss._Loss):
    ...
    def start_log(self):
        ...
        self.log = torch.cat((self.log, torch.zeros(1, len(self.loss)+1)))#考虑到对比损失
        # self.log = torch.cat((self.log, torch.zeros(1, 4)))#东阳版
