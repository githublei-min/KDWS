...
class RLFN_S2(nn.Module):
    ...
    def __init__(self,
        ...
        self.block_1 = block.RLFB2(feature_channels)
        self.block_2 = block.RLFB2(feature_channels)
        self.block_3 = block.RLFB2(feature_channels)
        self.block_4 = block.RLFB2(feature_channels)
        self.block_5 = block.RLFB2(feature_channels)
        self.block_6 = block.RLFB2(feature_channels)
